...
process(bcode) begin
	...
	case bcode is
		...
		when "00001011" => addr <= "00001111100";	--	007c	fconst_0
		...
		when "00001110" => addr <= "01010100011";	--	02a3	dconst_0
		...
		when "10000101" => addr <= "01010101010";	--	02aa	i2l
		when "00100110" => addr <= "01010101111";	--	02af	dload_0
		when "00011110" => addr <= "01010101111";	--	02af	lload_0
		when "00100111" => addr <= "01010110001";	--	02b1	dload_1
		when "00011111" => addr <= "01010110001";	--	02b1	lload_1
		when "00101000" => addr <= "01010110011";	--	02b3	dload_2
		when "00100000" => addr <= "01010110011";	--	02b3	lload_2
		when "00101001" => addr <= "01010110101";	--	02b5	dload_3
		when "00100001" => addr <= "01010110101";	--	02b5	lload_3
		when "00011000" => addr <= "01011000000";	--	02c0	dload
		when "00010110" => addr <= "01011000000";	--	02c0	lload
		when "01000111" => addr <= "01011001011";	--	02cb	dstore_0
		when "00111111" => addr <= "01011001011";	--	02cb	lstore_0
		when "01001000" => addr <= "01011001101";	--	02cd	dstore_1
		when "01000000" => addr <= "01011001101";	--	02cd	lstore_1
		when "01001001" => addr <= "01011001111";	--	02cf	dstore_2
		when "01000001" => addr <= "01011001111";	--	02cf	lstore_2
		when "01001010" => addr <= "01011010001";	--	02d1	dstore_3
		when "01000010" => addr <= "01011010001";	--	02d1	lstore_3
		when "00111001" => addr <= "01011011100";	--	02dc	dstore
		when "00110111" => addr <= "01011011100";	--	02dc	lstore
		when "11100100" => addr <= "01011100111";	--	02e7	getstatic_long
		when "11100101" => addr <= "01011110111";	--	02f7	putstatic_long
		when "11100110" => addr <= "01100001000";	--	0308	getfield_long
		when "11100111" => addr <= "01100100010";	--	0322	putfield_long
		when "01010010" => addr <= "01100111111";	--	033f	dastore
		when "01010000" => addr <= "01100111111";	--	033f	lastore
		when "00110001" => addr <= "01101101111";	--	036f	daload
		when "00101111" => addr <= "01101101111";	--	036f	laload
		when "01110101" => addr <= "01110011010";	--	039a	lneg
		when "01100001" => addr <= "01110100010";	--	03a2	ladd
		when "01100101" => addr <= "01110111100";	--	03bc	lsub
		when "01111101" => addr <= "01111100010";	--	03e2	lushr
		when "01111011" => addr <= "10000001010";	--	040a	lshr
		when "01111001" => addr <= "10000110010";	--	0432	lshl
		when "10000011" => addr <= "10001011010";	--	045a	lxor
		when "01111111" => addr <= "10001100010";	--	0462	land
		when "10000001" => addr <= "10001101010";	--	046a	lor
		when "10111011" => addr <= "10010011011";	--	049b	new
		when "10111101" => addr <= "10010011011";	--	049b	anewarray
		when "11000000" => addr <= "10010011011";	--	049b	checkcast
		when "11000001" => addr <= "10010011011";	--	049b	instanceof
		when "11100011" => addr <= "10010111000";	--	04b8	putfield_ref
		when "11100001" => addr <= "10010111000";	--	04b8	putstatic_ref
		when "11010001" => addr <= "10011010000";	--	04d0	jopsys_rd
		when "11010011" => addr <= "10011010000";	--	04d0	jopsys_rdmem
		when "11010010" => addr <= "10011010100";	--	04d4	jopsys_wr
		when "11010100" => addr <= "10011010100";	--	04d4	jopsys_wrmem
		when "11010101" => addr <= "10011011001";	--	04d9	jopsys_rdint
		when "11010110" => addr <= "10011011100";	--	04dc	jopsys_wrint
		when "11010111" => addr <= "10011011111";	--	04df	jopsys_getsp
		when "11011000" => addr <= "10011100010";	--	04e2	jopsys_setsp
		when "11011001" => addr <= "10011100110";	--	04e6	jopsys_getvp
		when "11011010" => addr <= "10011100111";	--	04e7	jopsys_setvp
		when "11011011" => addr <= "10011101001";	--	04e9	jopsys_int2ext
		when "11011100" => addr <= "10100000100";	--	0504	jopsys_ext2int
		when "11101000" => addr <= "10100100000";	--	0520	jopsys_memcpy
		when "11011101" => addr <= "10100100101";	--	0525	jopsys_nop
		when "11011111" => addr <= "10100100110";	--	0526	jopsys_cond_move
		when "11001100" => addr <= "10100101101";	--	052d	jopsys_inval

		when others => addr <= "10010001000";		--	0488	sys_noim
	end case;
end process;
...
process(int_pend, exc_pend, addr) begin
	...
	q <= addr;
	if exc_pend='1' then
		q <= "10001111100";		--	047c	sys_exc
	elsif int_pend='1' then
		q <= "10001110010";		--	0472	sys_int
	end if;
end process;
