...
public final class AP2PulldownStrength extends PPulldownStrength
{
    private TTLparen _tLparen_;
    private PStrength0 _strength0_;
    private TTRparen _tRparen_;

    public AP2PulldownStrength()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AP2PulldownStrength(
    ...
    {
        ((Analysis) sw).caseAP2PulldownStrength(this);
    }
