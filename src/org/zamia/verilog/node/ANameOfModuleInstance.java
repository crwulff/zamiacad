...
public final class ANameOfModuleInstance extends PNameOfModuleInstance
{
    private PIdentifier _identifier_;
    private PRange _range_;

    public ANameOfModuleInstance()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ANameOfModuleInstance(
    ...
    {
        ((Analysis) sw).caseANameOfModuleInstance(this);
    }
