...
public final class AP1NochangeTimingCheck extends PNochangeTimingCheck
{
    ...
    public Object clone()
    {
        return new AP1NochangeTimingCheck(
    ...
    {
        ((Analysis) sw).caseAP1NochangeTimingCheck(this);
    }
