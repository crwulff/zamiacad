...
public final class AP2PullupStrength extends PPullupStrength
{
    private TTLparen _tLparen_;
    private PStrength1 _strength1_;
    private TTRparen _tRparen_;

    public AP2PullupStrength()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseAP2PullupStrength(this);
    }
