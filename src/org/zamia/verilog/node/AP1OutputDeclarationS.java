...
public final class AP1OutputDeclarationS extends POutputDeclarationS
{
    ...
    public Object clone()
    {
        return new AP1OutputDeclarationS(
    ...
    {
        ((Analysis) sw).caseAP1OutputDeclarationS(this);
    }
