...
public final class AP18BinaryOperator extends PBinaryOperator
{
    private TTXor _tXor_;

    public AP18BinaryOperator()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AP18BinaryOperator(
            cloneNode(this._tXor_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAP18BinaryOperator(this);
    }
