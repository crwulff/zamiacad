...
public final class AP0PulldownStrength extends PPulldownStrength
{
    ...
    public Object clone()
    {
        return new AP0PulldownStrength(
    ...
    {
        ((Analysis) sw).caseAP0PulldownStrength(this);
    }
