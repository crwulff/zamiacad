...
public final class AP4UnaryModulePathOperator extends PUnaryModulePathOperator
{
    private TTPipe _tPipe_;

    public AP4UnaryModulePathOperator()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AP4UnaryModulePathOperator(
            cloneNode(this._tPipe_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAP4UnaryModulePathOperator(this);
    }
