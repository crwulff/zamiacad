...
public final class ABlockVariableType extends PBlockVariableType
{
    private PIdentifier _identifier_;
    private final LinkedList<PDimension> _dimension_ = new LinkedList<PDimension>();

    public ABlockVariableType()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseABlockVariableType(this);
    }
