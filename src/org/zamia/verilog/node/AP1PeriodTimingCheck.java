...
public final class AP1PeriodTimingCheck extends PPeriodTimingCheck
{
    private TKSperiod _kSperiod_;
    ...
    public AP1PeriodTimingCheck()
    {
        // Constructor
    }

    public AP1PeriodTimingCheck(
        @SuppressWarnings("hiding") TKSperiod _kSperiod_,
    ...
    public Object clone()
    {
        return new AP1PeriodTimingCheck(
            cloneNode(this._kSperiod_),
    ...
    {
        ((Analysis) sw).caseAP1PeriodTimingCheck(this);
    }

    public TKSperiod getKSperiod()
    {
        return this._kSperiod_;
    }

    public void setKSperiod(TKSperiod node)
    {
        if(this._kSperiod_ != null)
        {
            this._kSperiod_.parent(null);
        }
    ...
    {
        // Remove child
        if(this._kSperiod_ == child)
        {
            this._kSperiod_ = null;
            return;
        }
    ...
    {
        // Replace child
        if(this._kSperiod_ == oldChild)
        {
            setKSperiod((TKSperiod) newChild);
            return;
        }
