...
public final class AP1HoldTimingCheck extends PHoldTimingCheck
{
    private TKShold _kShold_;
    ...
    public AP1HoldTimingCheck()
    {
        // Constructor
    }

    public AP1HoldTimingCheck(
        @SuppressWarnings("hiding") TKShold _kShold_,
    ...
    public Object clone()
    {
        return new AP1HoldTimingCheck(
            cloneNode(this._kShold_),
    ...
    {
        ((Analysis) sw).caseAP1HoldTimingCheck(this);
    }

    public TKShold getKShold()
    {
        return this._kShold_;
    }

    public void setKShold(TKShold node)
    {
        if(this._kShold_ != null)
        {
            this._kShold_.parent(null);
        }
    ...
    {
        // Replace child
        if(this._kShold_ == oldChild)
        {
            setKShold((TKShold) newChild);
            return;
        }
