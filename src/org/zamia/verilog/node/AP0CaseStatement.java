...
public final class AP0CaseStatement extends PCaseStatement
{
    private TKCase _kCase_;
    ...
    public AP0CaseStatement()
    {
        // Constructor
    }

    public AP0CaseStatement(
        @SuppressWarnings("hiding") TKCase _kCase_,
    ...
    public Object clone()
    {
        return new AP0CaseStatement(
            cloneNode(this._kCase_),
    ...
    {
        ((Analysis) sw).caseAP0CaseStatement(this);
    }

    public TKCase getKCase()
    {
        return this._kCase_;
    }

    public void setKCase(TKCase node)
    {
        if(this._kCase_ != null)
        {
            this._kCase_.parent(null);
        }
    ...
    {
        // Replace child
        if(this._kCase_ == oldChild)
        {
            setKCase((TKCase) newChild);
            return;
        }
