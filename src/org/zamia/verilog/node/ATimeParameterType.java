...
public final class ATimeParameterType extends PParameterType
{
    private TKTime _kTime_;

    public ATimeParameterType()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ATimeParameterType(
            cloneNode(this._kTime_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseATimeParameterType(this);
    }
