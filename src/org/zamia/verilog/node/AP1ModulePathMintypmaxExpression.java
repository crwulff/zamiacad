...
public final class AP1ModulePathMintypmaxExpression extends PModulePathMintypmaxExpression
{
    ...
    public AP1ModulePathMintypmaxExpression(
        @SuppressWarnings("hiding") PModulePathExpression _e1_,
    ...
    public Object clone()
    {
        return new AP1ModulePathMintypmaxExpression(
            cloneNode(this._e1_),
            cloneNode(this._c1_),
            cloneNode(this._e2_),
            cloneNode(this._c2_),
    ...
    {
        ((Analysis) sw).caseAP1ModulePathMintypmaxExpression(this);
    }
    ...
    public void setE1(PModulePathExpression node)
    {
        if(this._e1_ != null)
        {
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        {
            setE1((PModulePathExpression) newChild);
            return;
        }
