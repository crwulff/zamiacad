...
public final class AP9BinaryOperator extends PBinaryOperator
{
    private TTLand _tLand_;

    public AP9BinaryOperator()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AP9BinaryOperator(
            cloneNode(this._tLand_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAP9BinaryOperator(this);
    }
