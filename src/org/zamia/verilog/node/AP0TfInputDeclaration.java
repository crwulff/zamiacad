...
public final class AP0TfInputDeclaration extends PTfInputDeclaration
{
    ...
    public Object clone()
    {
        return new AP0TfInputDeclaration(
    ...
    {
        ((Analysis) sw).caseAP0TfInputDeclaration(this);
    }
