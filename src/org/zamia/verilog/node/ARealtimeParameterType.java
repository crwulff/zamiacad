...
public final class ARealtimeParameterType extends PParameterType
{
    private TKRealtime _kRealtime_;

    public ARealtimeParameterType()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ARealtimeParameterType(
            cloneNode(this._kRealtime_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseARealtimeParameterType(this);
    }
