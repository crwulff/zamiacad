...
public final class AP1FunctionRangeOrType extends PFunctionRangeOrType
{
    private TKInteger _kInteger_;

    public AP1FunctionRangeOrType()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AP1FunctionRangeOrType(
            cloneNode(this._kInteger_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAP1FunctionRangeOrType(this);
    }
