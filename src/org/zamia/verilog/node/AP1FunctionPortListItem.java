...
public final class AP1FunctionPortListItem extends PFunctionPortListItem
{
    private TKInput _kInput_;
    private PTaskPortType _taskPortType_;
    private PIdentifier _identifier_;

    public AP1FunctionPortListItem()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AP1FunctionPortListItem(
    ...
    {
        ((Analysis) sw).caseAP1FunctionPortListItem(this);
    }
