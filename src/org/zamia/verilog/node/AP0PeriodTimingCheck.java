...
public final class AP0PeriodTimingCheck extends PPeriodTimingCheck
{
    ...
    public Object clone()
    {
        return new AP0PeriodTimingCheck(
    ...
    {
        ((Analysis) sw).caseAP0PeriodTimingCheck(this);
    }
