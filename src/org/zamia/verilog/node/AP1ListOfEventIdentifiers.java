...
public final class AP1ListOfEventIdentifiers extends PListOfEventIdentifiers
{
    private PIdentifier _identifier_;
    private final LinkedList<PDimension> _dimension_ = new LinkedList<PDimension>();

    public AP1ListOfEventIdentifiers()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AP1ListOfEventIdentifiers(
    ...
    {
        ((Analysis) sw).caseAP1ListOfEventIdentifiers(this);
    }
