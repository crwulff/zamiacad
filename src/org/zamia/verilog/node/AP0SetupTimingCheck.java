...
public final class AP0SetupTimingCheck extends PSetupTimingCheck
{
    ...
    public Object clone()
    {
        return new AP0SetupTimingCheck(
    ...
    {
        ((Analysis) sw).caseAP0SetupTimingCheck(this);
    }
