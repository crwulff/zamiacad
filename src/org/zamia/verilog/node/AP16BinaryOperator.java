...
public final class AP16BinaryOperator extends PBinaryOperator
{
    private TTAnd _tAnd_;

    public AP16BinaryOperator()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AP16BinaryOperator(
            cloneNode(this._tAnd_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAP16BinaryOperator(this);
    }
