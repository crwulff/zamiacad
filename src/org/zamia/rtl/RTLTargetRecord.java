...
public class RTLTargetRecord extends RTLModule {
	...
	public boolean equals(RTLModule module2_) {
		...
		if (!(module2_ instanceof RTLTargetRecord))
			return false;
		
		RTLTargetRecord csel2 = (RTLTargetRecord) module2_;
