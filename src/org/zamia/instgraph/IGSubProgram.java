...
public class IGSubProgram extends IGContainerItem {
	...
	static {
		...
		for (int i = 0; v[i] != IGBuiltin._fBuiltins_separator ; i++)
			fBuiltins.put(v[i].name(), v[i]);
	}
