 ...
 * 
 * Created by Guenter Bartsch on Oct 1, 2011
 */
...
/**
 * Convert an Object to GraphViz' dot language
 * 
 * @author Guenter Bartsch
 *
 */

public class Object2Dot {

	private Object fRootObject;

	private HashSet<String> fBlacklistedFields = new HashSet<String>();

	private HashSet<String> fBlacklistedClasses = new HashSet<String>();

	public Object2Dot(Object aRootObject) {
	...
	public void convert(PrintWriter aOut) {
		...
		todo.push(new DotJob("n" + fRootObject.hashCode(), fRootObject));
	...
	public void blacklistClass(String aClassName) {
		fBlacklistedClasses.add(aClassName);
	}

	private boolean isBlacklisted(Object aObj) {

		String cls = aObj.getClass().getName();

		return fBlacklistedClasses.contains(cls);
	}
