...
/**
 * Bidirectional interface access (BUFFER, LINKAGE, INOUT)
 * @author Guenter Bartsch
 *
 */
public class ZILOperationAccessInterface extends ZILOperation {

	private ZILInterface fInterface;
	private PortDir fDir;

	public ZILOperationAccessInterface(ZILInterface aInterface, PortDir aDir, ZILIContainer aContainer, ASTObject aSrc) {
		super(aInterface.getType(), aContainer, aSrc);
	...
	public String toString() {
		return "ZILOperationAccessInterface (intf="+fInterface+", dir="+fDir+")";
	}
	...
	public void computeReadSignals(HashSetArray<ZILSignal> aReadSignals) {
		if (fInterface instanceof ZILSignal)
			aReadSignals.add((ZILSignal) fInterface);
	}
}
