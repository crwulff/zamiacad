 ...
 * 
 */
public class ZILOperationOpenArrayTypeAttribute extends ZILOperation {

	public enum ATAOp {LEFT, RIGHT, LOW, HIGH, LENGTH, ASCENDING};
	...
	public String toString() {
		return "OperationArrayTypeAttribute (op="+fOp+", operand=" + fOperand + ", dimension="+fDimension+")";
	}
