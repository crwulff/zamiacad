...
public class OpenUnitByPathAction implements IWorkbenchWindowActionDelegate {
	...
	public void run(IAction action) {
		...
		UnitPathDialog dialog = new UnitPathDialog(fWindow.getShell(), zPrj);
		dialog.setTitle("Specify Unit Path");
