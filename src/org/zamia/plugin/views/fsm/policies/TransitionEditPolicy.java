...
import org.zamia.plugin.views.fsm.model.commands.DeleteConnectionCommand;
import org.zamia.plugin.views.fsm.model.commands.SplitTransitionCommand;
import org.zamia.plugin.views.fsm.parts.TransitionPart;
...
protected Command getSplitTransitionCommand(Request request){
	...
	cmd.setParent(
		((StructuredFSMState) ((TransitionPart) getHost())
			.getSource()
			.getParent()
			.getModel()));
	cmd.setNewActivity(((FSMState)((CreateRequest)request).getNewObject()));		
	return cmd;
}
/**
