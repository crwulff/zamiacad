...
private FSMState oldSource;
private FSMState oldTarget;
private Transition transition;

private FSMState newActivity;
...
public void execute() {
	...
	newIncomingTransition = new Transition(oldSource, newActivity, null, false);
	newOutgoingTransition = new Transition(newActivity, oldTarget, null, false);
}
 ...
 */
public void setParent(StructuredFSMState activity) {
	parent = activity;
}
 ...
 */
public void setNewActivity(FSMState activity) {
