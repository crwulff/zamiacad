...
public class DMUID implements Serializable {
	...
	public DMUID(LUType aType, String aLibId, String aId, String aArchId) {
	...
	public boolean equals(Object aObject) {
		...
		if (!(aObject instanceof DMUID))
			return false;

		DMUID duuid = (DMUID) aObject;
	...
	public static DMUID parse(String aToplevel) throws ZamiaException {
		...
		return new DMUID(type, libId, entityId, archId);
	}
	...
	public DMUID cloneDUUID() {
		return new DMUID(fType, fLibId, fId, fArchId);
	}

	public DMUID getEntityDUUID() {

		if (fType == LUType.Architecture) {
			return new DMUID(LUType.Entity, fLibId, fId, null);
		}
