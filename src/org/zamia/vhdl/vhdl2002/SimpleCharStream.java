 ...
 * 
 */
// this was originally generated by JavaCC but for tab size = 1 we need to modify it manually.
...
public class SimpleCharStream implements CharStream {
	...
	public final static int DEFAULT_BUFSIZE = 8192;
	...
	public SimpleCharStream(java.io.Reader dstream, int startline, int startcolumn) {
		this(dstream, startline, startcolumn, DEFAULT_BUFSIZE);
	}

	public SimpleCharStream(java.io.Reader dstream) {
		this(dstream, 1, 1, DEFAULT_BUFSIZE);
	}
	...
	public void ReInit(java.io.Reader dstream, int startline, int startcolumn) {
		ReInit(dstream, startline, startcolumn, DEFAULT_BUFSIZE);
	}

	public void ReInit(java.io.Reader dstream) {
		ReInit(dstream, 1, 1, DEFAULT_BUFSIZE);
	}
	...
	public SimpleCharStream(java.io.InputStream dstream, String encoding, int startline, int startcolumn) throws java.io.UnsupportedEncodingException {
		this(dstream, encoding, startline, startcolumn, DEFAULT_BUFSIZE);
	}
	...
	public SimpleCharStream(java.io.InputStream dstream, String encoding) throws java.io.UnsupportedEncodingException {
		this(dstream, encoding, 1, 1, DEFAULT_BUFSIZE);
	}
	...
	public void ReInit(java.io.InputStream dstream, String encoding) throws java.io.UnsupportedEncodingException {
		ReInit(dstream, encoding, 1, 1, DEFAULT_BUFSIZE);
	}
	...
	public void ReInit(java.io.InputStream dstream, String encoding, int startline, int startcolumn) throws java.io.UnsupportedEncodingException {
		ReInit(dstream, encoding, startline, startcolumn, DEFAULT_BUFSIZE);
	}
